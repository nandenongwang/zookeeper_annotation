...
class ZKWatchManager implements ClientWatchManager {
    ...
    //region 存储不同类型的watcher
    /**
     * 监听数据变化监听器
     */
    private final Map<String/* path */, Set<Watcher>> dataWatches = new HashMap<>();
    /**
     * 监听节点变化监听器
     */
    private final Map<String/* path */, Set<Watcher>> existWatches = new HashMap<>();
    /**
     * 监听子节点变化监听器
     */
    private final Map<String/* path */, Set<Watcher>> childWatches = new HashMap<>();
    /**
     * 永久监听器  【永久监听器对所有有效事件类型均生效】
     */
    private final Map<String/* path */, Set<Watcher>> persistentWatches = new HashMap<>();
    /**
     * 永久递归监听器  【永久监听器对所有有效事件类型均生效】
     * 递归监听器向前递归
     */
    private final Map<String/* path */, Set<Watcher>> persistentRecursiveWatches = new HashMap<>();
    //endregion
    ...
    /**
     * 默认watcher 【创建zookeeper客户端实例时的watcher】
     */
    ...
    public Set<Watcher> materialize(Watcher.Event.KeeperState state, Watcher.Event.EventType type, String clientPath) {
        ...
        switch (type) {
            ...
            //region NodeDataChanged、NodeCreated 【数据变更、节点变更类型监听器、永久监听器】
            ...
            //region NodeChildrenChanged 【子节点变更类型监听器、永久监听器】
