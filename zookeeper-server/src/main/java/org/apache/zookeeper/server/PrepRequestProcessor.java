...
public class PrepRequestProcessor extends ZooKeeperCriticalThread implements RequestProcessor {
    ...
    /**
     * 根据操作类型对请求进行预处理
     * 事务操作：根据请求中命令类型【type】与请求命令内容【bytebuffer】解析出具体命令、并分别检查
     * 读操作：检查session
     ...
     */
    private PrecalculatedDigest precalculateDigest(DigestOpCode type, String path, byte[] data, StatPersisted s) throws KeeperException.NoNodeException {
